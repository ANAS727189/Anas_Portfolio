...
export function generatePersonSchema() {
  return {
    ...
    '@type': 'Person',
    name: 'Anas Khan',
    alternateName: ['Anas', 'ANAS727189', '83Anas_is_me' , 'Anas_Khan83', 'coderX083', 'Anas_is_me'],
    url: siteConfig.url,
    image: `${siteConfig.url}/meta/hero.png`,
    email: siteConfig.author.email,
    telephone: '+919794354555',
    jobTitle: 'Software Engineer',
    description: 'Anas Khan is a Software Engineer and Full Stack Developer, specializing in React, Node.js, Solidity, Go, Next.js, Python and Web3 technologies. 3x Hackathon Winner, ICPC 2025 Regionalist and Open Source Contributor.',
    alumniOf: {
