...
import CursorCat from "@/components/CursorCat"; // ← adjust path if needed
...
const Hero = () => {
  ...
  return (
    <>
      {/* 🐱 Cursor cat — fixed-position, follows the mouse everywhere */}
      <CursorCat />

      <section className="flex flex-col items-center text-center mt-1 space-y-6">
        {/* Avatar */}
        <button
          type="button"
